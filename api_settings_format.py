...
broker = "192.168.0.16"
balances = [
    {"category_name": "Dagligvarer", "category_id": "cd7c625b-****-****-****-10bb7e69d29f"},
    {"category_name": "Spise ute", "category_id": "d9c85ede-****-****-****-10bb7e692d13"},
    {"category_name": "Lek og fritid", "category_id": "2fa73af5-****-****-****-10bb7e69c9c9"},
]
account_statuses = [{"Name": "Brukskonto", "Number": 97000000321, "ID": "ABCDEF1234567890ABCDEF0123456789"}]
